...
CREATE VIEW pg_stat_all_tables AS
    SELECT
            ...
            pg_stat_get_autovacuum_lock_skipped_count(C.oid) AS autovacuum_lock_skipped_count,
            pg_stat_get_autoanalyze_lock_skipped_count(C.oid) AS autoanalyze_lock_skipped_count,
