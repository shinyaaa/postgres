				   ...
				   Datum reloptions)
{
	...
	values[Anum_pg_class_relcolmasking - 1] = BoolGetDatum(rd_rel->relcolmasking);
	values[Anum_pg_class_relforcecolmasking - 1] = BoolGetDatum(rd_rel->relforcecolmasking);
