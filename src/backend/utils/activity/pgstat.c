...
static const PgStat_KindInfo pgstat_kind_builtin_infos[PGSTAT_KIND_BUILTIN_SIZE] = {
	...
	[PGSTAT_KIND_DEPRECATED] = {
		...
		.flush_static_cb = pgstat_deprecated_flush_cb,
		.init_shmem_cb = pgstat_deprecated_init_shmem_cb,
		.reset_all_cb = pgstat_deprecated_reset_all_cb,
		.snapshot_cb = pgstat_deprecated_snapshot_cb,
	},
